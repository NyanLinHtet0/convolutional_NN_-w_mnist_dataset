...
class DataPipeline:
    ...
    def load_split(self, split="train", target_size=None, normalize=True):
        """
        Returns:
            X: (N, height, width)
            y: (N,)
    ...
    def resize_and_save(self, split="train", new_size=(10, 10),
                        suffix="_resized", overwrite=False):
            ...
            for img_path in images:
                ...
                if overwrite:
                    ...
                    out_path = img_path.with_name(
                        img_path.stem + suffix + img_path.suffix
                    )
