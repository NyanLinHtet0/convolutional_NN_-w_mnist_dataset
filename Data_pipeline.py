...
dp.load_and_npz_save("test", target_size=image_inputsize, max_class=10, normalize=True)
dp.load_and_npz_save(target_size=image_inputsize, max_class=10,normalize=True)
# dp.load_and_npz_save("test_indiv", target_size=image_inputsize, max_class=3,normalize=True)
